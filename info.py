...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002799537836'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002520222866'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002799537836')  # Channel/Group ID for force sub (make sure bot is admin)
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002799537836 -1002312706219 -1002409869914 -1002491588102 -1002447923581').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://database:database@cluster0.a3svukr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://cinemahub77:S5v7CGWyh1qZJgHr@cluster0.qtqaxm7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-100'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/how_to_downlod_7')  # How to open tutorial link for verification
...
URL = "https://atomic-jacquelynn-nitish7-50046b88.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else "https://{}/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://statistical-nerissa-nitish7-92d67ebd.koyeb.app/".format(FQDN)
else:
    URL = "https://statistical-nerissa-nitish7-92d67ebd.koyeb.app/".format(FQDN)
